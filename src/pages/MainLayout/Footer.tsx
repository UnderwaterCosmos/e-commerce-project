...
export default React.memo(function Footer() {
  ...
  return (
    <footer className={footer}>
      <span>By UnderwaterCosmos, Frontend Engineer, 2024</span>
      <a href="https://github.com/UnderwaterCosmos" target="blank">
        <svg
          width="20"
          height="20"
          viewBox="0 0 20 20"
